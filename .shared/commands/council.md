...
7. Treat explicit `@file` references in the current request as host-side context. Read or expand them and include the relevant file text directly in the task brief you send to Council.
